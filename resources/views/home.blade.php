...
<body>
    ...
    <header class="navbar sticky-top bg-light  flex-md-nowrap p-0 shadow">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6" href="#">Panel zarządzania mikrokontrolerem</a>
                        ...
                        <form class="row g-3" method="POST" action="{{ route('save.settings') }}">
                            ...
                            <div class="col-auto">
                                ...
                                <input type="number" class="form-control" id="fan_active_under_value"
                                    name="fan_active_under_value" value="" placeholder="Podaj liczbę od 0 do 70"
                                ...
                                <div class="row">
                                    <div class="col-10">
                                        <blockquote class="blockquote mb-0">
                                            <p>fgdfgf-dfsdfsdf-fsdfsdf-fsdf</p>
                                        </blockquote>
                                    </div>
                                    <div class="col-2">
